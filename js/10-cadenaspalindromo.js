function hacerclic() {
    document.querySelector("#pag10").onclick = mensajes;
}
...
function mensajes() {
    msg.innerHTML = (palindromo("La ruta nos aporto otro paso natural"));
    msg.innerHTML = msg.innerHTML + (palindromo("Esta frase no se parece a ningun palindromo"));
}
